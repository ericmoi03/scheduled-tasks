...
# print(birthdays_dict[9,8]["name"])

# if today_tuple in birthdays_dict: #Note: Using today_tuple is the same as writing out (today_month, today_day)
#     print("yes")
# else:
#     print("no")

if (today_month, today_day) in birthdays_dict:
    birthday_name = birthdays_dict[today_month,today_day]["name"]
    random_letter_num = random.randint(1,3)
    with open("letter_templates/letter_"+str(random_letter_num)+".txt", "r") as file:
